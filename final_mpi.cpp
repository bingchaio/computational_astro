...
double t_end = dt*10.0;                         // ending time                             
...
int main(int argc, char *argv[]) {
    ...
    double * x_cp = new double[n]; //positions of the particles
    double * y_cp = new double[n];
    double * z_cp = new double[n];
    double * vx_cp = new double[n]; //velocities of the particles
    double * vy_cp = new double[n];
    double * vz_cp = new double[n];
    int frame = 0;

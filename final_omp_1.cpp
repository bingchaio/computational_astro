...
array3<double>  rho_x(Nx,Ny,Nz,sizeof(Complex)); // density
array3<double>  phi_x(Nx,Ny,Nz,sizeof(Complex)); // potential
array3<Complex> phi_k(Nx,Ny,Nz/2+1,sizeof(Complex)); // FT of potential
array3<Complex> rho_k(Nx,Ny,Nz/2+1,sizeof(Complex)); // FT of density
...
//Poisson Solver (FFT)
void FFT(array3<double> *rho_x,array3<double> *phi_x,double ***W){
